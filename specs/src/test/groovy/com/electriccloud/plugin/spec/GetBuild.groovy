...
//    @Shared
    ...
    @Unroll
    def "#caseId. Smoke. Get Build with waiting"() {
        given:
        ...
        where:
        caseId       | requestBy | buildDefinitionName | waitTimeout
        'CHANGEME_1' | 'id'      | definitionName      | 10 + (60 * 3)
    }

    @Unroll
    def "#caseId. Smoke. Get Build without wait"() {
        given:
        def resultJobPropertyName = 'build'
        resultPropertySheet = '/myJob/' + resultJobPropertyName
        resultFormat = 'propertySheet'
